// simplified version from @toji - gl-matrix
// original: https://github.com/toji/gl-matrix/blob/master/src/mat4.js
...
function fromQuat2(out, a) {
  let translation = Float32Array(3)
  let bx = -a[0],
    by = -a[1],
    bz = -a[2],
    bw = a[3],
...
// function lookAtPYR(out, pitch, yaw, roll) {
//   const sy = Math.sin(roll)
//   const cy = Math.cos(roll)
//   const sp = Math.sin(yaw)
//   const cp = Math.cos(yaw)
//   const sr = Math.sin(pitch)
